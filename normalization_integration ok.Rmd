...
```
#per compararlo a quello di prima
DimPlot(obj, reduction = "umap.unintegrated", group.by = c("Method"))|DimPlot(obj, reduction = "umap.cca", group.by = c("Method"))
...
obj<- RunUMAP(obj, assay= "SCT", reduction.name="pca.sct")
DimPlot(obj, reduction = "", group.by = c("Method"))
