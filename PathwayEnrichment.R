...
gse <- gseGO(geneList = gene_list, 
             ont = "BP", # Use Biological Process ontology but there are several
             keyType = "ENTREZID", 
             nPerm = 100, # Number of permutations for statistical testing, meglio 1000 to have mre permutation but non abbiamo tempo
             ...
             seed=42) #we are doing permutation se non lo metti sarà sempre diversa l'analisi, non cambiarlo
